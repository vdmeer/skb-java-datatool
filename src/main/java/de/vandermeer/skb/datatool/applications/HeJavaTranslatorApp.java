 ...
 * @since      v0.0.2
 */
public class HeJavaTranslatorApp extends AbstractAppliction {

	/** Application name. */
	public final static String APP_NAME = "dt-hemap-jtrans";
	...
	protected AO_FileOut optionFileOut = new AO_FileOut('o', false, "output file name", "sets the output file name", "The output file name, without extension, to write the final Java class to (class name is generated from the filename).");
	...
	/**
	 * Returns a new HTML Element map translator generator tool.
	...
	public void runApplication() {
		...
		try{
			...
			bl.setType(HtmlElementEntry.ENTRY_TYPE);
